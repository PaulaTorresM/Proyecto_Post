            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4 ml-60">
                                <button type="submit" class="btn btn-primary w-24 ml-28 "><svg fill="none" class="ml-6 " height="1.5em" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4 mt-2 ml-60">
                                <a href="{{ route('post.index') }}" class="btn btn-secondary pt-2 mt-1 w-24 ml-28"  >
