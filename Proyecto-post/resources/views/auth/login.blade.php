            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4 ml-72">
                                <button type="submit" class="btn btn-primary mt-2 w-40  ml-12">
                                    <svg fill="none" stroke="currentColor"  class="ml-14 " height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4 mt-2 ml-60">
                                <a href="{{ route('post.index') }}" class="btn btn-secondary pt-2 mt-1 w-24 ml-32"  >
